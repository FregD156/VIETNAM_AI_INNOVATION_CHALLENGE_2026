...
## 5. QUY ƯỚC STYLING (VANILLA CSS)

- Tất cả màu sắc, spacing, font-size khai báo dưới dạng CSS Variables trong `styles/theme.css`, KHÔNG hardcode giá trị màu (`#1a2b3c`) trực tiếp trong file component CSS.
- Bảng màu tham chiếu (điều chỉnh theo brand SHB thật khi có):
```css
:root {
  --color-bg-primary: #0b1220;      /* navy đen nền chính */
  --color-bg-glass: rgba(255,255,255,0.06);
  --color-accent-gold: #d4af37;
  --color-accent-navy: #1e3a5f;
  --color-success: #10b981;         /* Clause còn hiệu lực */
  --color-danger: #ef4444;          /* Clause hết hiệu lực */
  --color-edge-supersedes: #ef4444;
  --color-edge-references: #3b82f6;
...
- Hiệu ứng glass dùng chung 1 class utility `.glass-panel` định nghĩa 1 lần trong `theme.css`, không lặp lại `backdrop-filter` rải rác nhiều nơi.
